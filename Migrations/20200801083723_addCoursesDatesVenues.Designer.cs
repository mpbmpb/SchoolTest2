...
namespace SchoolTest2.Migrations
{
    ...
    [Migration("20200801083723_addCoursesDatesVenues")]
    partial class addCoursesDatesVenues
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SchoolTest2.Models.Contact", b =>
                {
            ...
            modelBuilder.Entity("SchoolTest2.Models.Course", b =>
                {
            ...
            modelBuilder.Entity("SchoolTest2.Models.CourseDate", b =>
                {
            ...
            modelBuilder.Entity("SchoolTest2.Models.CourseDesign", b =>
                {
                    b.Property<int>("CourseDesignId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("SchoolTest2.Models.CourseSeminar", b =>
                {
                    b.Property<int>("CourseDesignId")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("SchoolTest2.Models.Venue", b =>
                {
                    b.Property<int>("VenueId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("SchoolTest2.Models.Course", b =>
                {
                    b.HasOne("SchoolTest2.Models.CourseDesign", "CourseDesign")
                        .WithMany()
            ...
            modelBuilder.Entity("SchoolTest2.Models.CourseDate", b =>
                {
                    b.HasOne("SchoolTest2.Models.Course", "Course")
                        .WithMany("CourseDates")
                        .HasForeignKey("CourseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SchoolTest2.Models.Venue", "Venue")
                        .WithMany()
            ...
            modelBuilder.Entity("SchoolTest2.Models.CourseDesign", b =>
                {
                    b.HasOne("SchoolTest2.Models.Seminar", null)
            ...
            modelBuilder.Entity("SchoolTest2.Models.Venue", b =>
                {
                    b.HasOne("SchoolTest2.Models.Contact", "Contact1")
                        .WithMany()
                        .HasForeignKey("Contact1ContactId");

                    b.HasOne("SchoolTest2.Models.Contact", "Contact2")
                        .WithMany()
